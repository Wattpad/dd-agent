...
STATUS_VARS = {
    ...
    'Handler_commit': ('mysql.handler.commit', RATE),
    'Handler_delete': ('mysql.handler.delete', RATE),
    'Handler_external_lock': ('mysql.handler.external_lock', RATE),
    'Handler_prepare': ('mysql.handler.prepare', RATE),
    'Handler_read_first': ('mysql.handler.read_first', RATE),
    'Handler_read_key': ('mysql.handler.read_key', RATE),
    'Handler_read_last': ('mysql.handler.read_last', RATE),
    'Handler_read_next': ('mysql.handler.read_next', RATE),
    'Handler_read_prev': ('mysql.handler.read_prev', RATE),
    'Handler_read_rnd': ('mysql.handler.read_rnd', RATE),
    'Handler_read_rnd_next': ('mysql.handler.read_rnd_next', RATE),
    'Handler_rollback': ('mysql.handler.rollback', RATE),
    'Handler_update': ('mysql.handler.update', RATE),
    'Handler_write': ('mysql.handler.write', RATE),
    ...
    'Innodb_buffer_pool_pages_misc': ('mysql.innodb.buffer_pool_pages_misc', GAUGE),
    ...
    'Open_streams': ('mysql.performance.open_streams', GAUGE),
    'Open_table_definitions': ('mysql.performance.open_table_definitions', GAUGE),
    'Opened_files': ('mysql.performance.opened_files', RATE),
    'Opened_table_definitions': ('mysql.performance.opened_table_definitions', RATE),
    ...
    'Table_open_cache_hits': ('mysql.performance.table_open_cache_hits', RATE),
    'Table_open_cache_misses': ('mysql.performance.table_open_cache_misses', RATE),
    'Table_open_cache_overflows': ('mysql.performance.table_open_cache_overflows', RATE),
    'Threads_cached': ('mysql.performance.threads_cached', GAUGE),
    'Threads_created': ('mysql.performance.threads_created', RATE)
}
